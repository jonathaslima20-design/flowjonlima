...
export function MangaTheme({ profile, links, socials, videos, banners, sectionOrder, track, preview }: BioThemeProps) {
        ...
        <div className="flex flex-col gap-3">
          {orderedSections(sectionOrder, {
            socials: socials?.length > 0 ? (
              <div key="socials" className="pt-3 flex items-center gap-4 flex-wrap" style={{ borderTop: `2px solid ${borderColor}` }}>
                {socials.map((soc: any) => {
